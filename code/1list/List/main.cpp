...
signed main()
{
    ...
    cout << "opt-1: Initialize list H" << endl;
    List<char> H;
    cout << endl;
    cout <<
    ...
    cout << endl;
    cout << "opt-3: Traverse list H and the length of L" << endl;
    H.output();
    cout << H.length() << endl;
    cout << endl;
    cout << "opt-4: Check whether the list H is empty" << endl;

    if (H.empty()) cout << "Yes" << endl;
    else cout << "No" << endl;
    cout << endl;
    cout << "opt-5: Output the third element in the list H" << endl;
    ...
    cout << endl;
    cout << "opt-9: Output list H" << endl;
    H.output();
    cout << endl;
    cout << "opt-10: Release list H" << endl;
    return 0;
}
