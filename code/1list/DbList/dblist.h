...
{
    DbListNode<T> *temp = new DbListNode<T> { e, this->rear };
...
template<class T>
void DbList<T>::output() const
{
    DbListNode<T> *temp = head->next;
    std::cout << "Positive traversal: ";
